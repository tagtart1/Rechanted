...
import net.tagtart.rechanted.entity.ThrownWarpGemEntity;
...
public class WarpGemItem  extends Item {
    ...
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.rechanted.warp_gem").withStyle(ChatFormatting.AQUA);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        Component itemDescription = Component.translatable("item.rechanted.warp_gem.desc");
        Component loreDescription = Component.translatable("item.rechanted.warp_gem.desc_lore");
