...
public class ChanceGemItem extends Item {
    ...
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.rechanted.chance_gem").withStyle(ChatFormatting.AQUA);
    }

    @Override
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        Component itemDescription = Component.translatable("item.rechanted.chance_gem.desc");
        Component loreDescription = Component.translatable("item.rechanted.chance_gem.desc_lore");
