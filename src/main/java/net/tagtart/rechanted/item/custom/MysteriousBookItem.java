...
public class MysteriousBookItem extends Item {
    ...
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.rechanted.mysterious_book").withStyle(ChatFormatting.LIGHT_PURPLE);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents,
        ...
        Component itemDescription = Component.translatable("item.rechanted.mysterious_book.desc");
