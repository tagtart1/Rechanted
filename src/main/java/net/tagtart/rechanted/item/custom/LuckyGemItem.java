...
import net.tagtart.rechanted.entity.LuckyGemEntity;
...
public class LuckyGemItem extends Item {
    ...
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.rechanted.lucky_gem").withStyle(ChatFormatting.AQUA);
    }

    @Override
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        Component itemDescription = Component.translatable("item.rechanted.lucky_gem.desc");
        Component loreDescription = Component.translatable("item.rechanted.lucky_gem.desc_lore");
