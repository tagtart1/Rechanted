...
public class TastyGemItem extends Item {
    ...
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.rechanted.tasty_gem").withStyle(ChatFormatting.AQUA);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        Component itemDescription = Component.translatable("item.rechanted.tasty_gem.desc");
        Component loreDescription = Component.translatable("item.rechanted.tasty_gem.desc_lore");
