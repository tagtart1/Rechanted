...
public class ShinyChanceGemItem extends Item {
    ...
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.rechanted.shiny_chance_gem").withStyle(ChatFormatting.LIGHT_PURPLE);
    }

    @Override
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents,
            TooltipFlag tooltipFlag) {
        Component itemDescription = Component.translatable("item.rechanted.shiny_chance_gem.desc");
        Component loreDescription = Component.translatable("item.rechanted.shiny_chance_gem.desc_lore");
    ...
    public boolean overrideStackedOnOther(ItemStack stack, Slot otherSlot, ClickAction action, Player player) {
        ...
        if (!(item instanceof RechantedBookItem)) {
