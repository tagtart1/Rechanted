...
public class SmithingGemItem extends SmithingTemplateItem {
    ...
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.rechanted.smithing_gem").withStyle(ChatFormatting.AQUA);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        String itemDescriptionString = Component.translatable("item.rechanted.smithing_gem.desc").getString();
        String loreDescriptionString = Component.translatable("item.rechanted.smithing_gem.desc_lore").getString();
