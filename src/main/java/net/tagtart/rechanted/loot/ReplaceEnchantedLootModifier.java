...
public class ReplaceEnchantedLootModifier extends LootModifier {
    ...
    protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        if (!RechantedCommonConfigs.REPLACE_ENCHANTED_LOOT.get()) {
        ...
        boolean excludeLowerTiers = RechantedCommonConfigs.EXCLUDE_LOWER_TIER_LOOT.get();
        ...
        boolean nerfFishing = RechantedCommonConfigs.NERF_FISHING_LOOT.get();
