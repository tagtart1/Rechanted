...
public record HellsFuryEnchantmentEffect(float baseDamage, float damagePerLevel) implements EnchantmentEntityEffect {
    ...
    public void apply(ServerLevel level, int enchantmentLevel, EnchantedItemInUse item, Entity entity, Vec3 origin) {
        ...
        Rechanted.LOGGER.info("Hell's Fury triggered! Current dimension: {}, Is Nether: {}", 
        ...
        if (entity instanceof LivingEntity target) {
            ...
            Rechanted.LOGGER.info("Hell's Fury applying {} damage (level {})", bonusDamage, enchantmentLevel);
            ...
            if (attacker instanceof Player player) {
                ...
                Rechanted.LOGGER.info("Hell's Fury attack strength: {} (0.0=spam, 1.0=full charge)", attackStrength);
