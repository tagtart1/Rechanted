...
public final class TelekinesisEnchantmentHandler {
    private static final String TELEKINESIS_DROP_TAG = "rechanted_telekinesis_drop";
    private static final String TELEKINESIS_EXP_TAG = "rechanted_telekinesis_exp";
    private static final String TELEKINESIS_OWNER_PREFIX = "rechanted_telekinesis_owner_";
    private static final String TELEKINESIS_START_TICK_KEY = "rechanted_telekinesis_start_tick";
    private static final String TELEKINESIS_EXP_START_TICK_KEY = "rechanted_telekinesis_exp_start_tick";
