package net.tagtart.rechanted.command;
...
public final class ModCommands {
    ...
    private static final GemProgressRow[] GEM_ROWS = new GemProgressRow[] {
            new GemProgressRow("item.rechanted.chance_gem", "held_chance_gem", ChatFormatting.AQUA),
            new GemProgressRow("item.rechanted.shiny_chance_gem", "held_shiny_chance_gem", ChatFormatting.LIGHT_PURPLE),
            new GemProgressRow("item.rechanted.return_gem", "held_return_gem", ChatFormatting.AQUA),
            new GemProgressRow("item.rechanted.tasty_gem", "held_tasty_gem", ChatFormatting.AQUA),
            new GemProgressRow("item.rechanted.warp_gem", "held_warp_gem", ChatFormatting.AQUA),
            new GemProgressRow("item.rechanted.lucky_gem", "held_lucky_gem", ChatFormatting.AQUA),
            new GemProgressRow("item.rechanted.clone_gem", "held_clone_gem", ChatFormatting.AQUA),
            new GemProgressRow("item.rechanted.smithing_gem", "held_smithing_gem", ChatFormatting.AQUA)
    };
