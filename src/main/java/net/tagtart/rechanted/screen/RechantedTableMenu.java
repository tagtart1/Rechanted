...
public class RechantedTableMenu extends AbstractContainerMenu {
    ...
    public RechantedTableMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public RechantedTableMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(ModMenuTypes.RECHANTED_TABLE_MENU.get(), pContainerId);
