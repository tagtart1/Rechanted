...
public class RechantmentTablePoolDisplayScreen extends AbstractContainerScreen<RechantmentTablePoolDisplayMenu> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Rechantment.MOD_ID, "textures/gui/enchant_table_loot_pool_screen.png");

    private static final ResourceLocation LEFT_ARROW_LOCATION = ResourceLocation.fromNamespaceAndPath(Rechantment.MOD_ID, "textures/gui/arrow_button_left.png");
    private static final ResourceLocation RIGHT_ARROW_LOCATION = ResourceLocation.fromNamespaceAndPath(Rechantment.MOD_ID, "textures/gui/arrow_button_right.png");
    ...
    private static final ResourceLocation ULTIMATE_LINE_LOCATION = ResourceLocation.fromNamespaceAndPath(Rechantment.MOD_ID, "textures/gui/enchant_table_loot_pool_effect_ultimate.png");
