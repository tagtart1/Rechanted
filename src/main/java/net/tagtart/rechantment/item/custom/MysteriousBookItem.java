...
public class MysteriousBookItem extends Item {

    public MysteriousBookItem(Properties properties) {
        super(properties);
    }

    @Override
    public Component getName(ItemStack pStack) {
        return Component.translatable("item.rechantment.mysterious_book").withStyle(ChatFormatting.LIGHT_PURPLE);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        Component itemDescription = Component.translatable("item.rechantment.mysterious_book.description");
