...
public class ItemEntityTrailHandler {
    private static final String TRAIL_ACTIVE_KEY = "rechantment_item_trail_active";
    private static final String TRAIL_PARTICLE_KEY = "rechantment_item_trail_particle";
    private static final String TRAIL_INTERVAL_TICKS_KEY = "rechantment_item_trail_interval_ticks";
    private static final String TRAIL_PARTICLE_COUNT_KEY = "rechantment_item_trail_particle_count";
