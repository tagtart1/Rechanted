...
public class RechantmentTableRenderer implements BlockEntityRenderer<RechantmentTableBlockEntity> {
    ...
    public void render(RechantmentTableBlockEntity blockEntity, float partialTick, PoseStack poseStack,
    ...
    private void renderBook(RechantmentTableBlockEntity blockEntity, float partialTick, PoseStack poseStack,
            MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        if (blockEntity.tableState == RechantmentTableBlockEntity.CustomRechantmentTableState.BonusPending) {
            ...
            long stateStartTime = gameTime - (RechantmentTableBlockEntity.BONUS_PENDING_ANIMATION_LENGTH_TICKS
        ...
        if (blockEntity.tableState == RechantmentTableBlockEntity.CustomRechantmentTableState.BonusEarned) {
            ...
            long stateStartTime = gameTime - (RechantmentTableBlockEntity.BONUS_EARNED_ANIMATION_LENGTH_TICKS
                    - blockEntity.currentStateTimeRemaining);
            float time = (gameTime + partialTick - stateStartTime);
    ...
    private void renderLapisItems(RechantmentTableBlockEntity blockEntity, float partialTick, PoseStack poseStack,
            MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
    ...
    private static float getVanillaBookFacingYRotation(RechantmentTableBlockEntity be, float partialTick) {
